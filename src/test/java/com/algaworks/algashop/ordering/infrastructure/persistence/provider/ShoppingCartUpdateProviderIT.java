...
//9.7. Como lidar com atualizações em massa - 16'
@DataJpaTest
@Import({
...
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD) //9.7. Como lidar com atualizações em massa - 28'50"
class ShoppingCartUpdateProviderIT {
    ...
    //9.7. Como lidar com atualizações em massa - 29'40"
    @Test
    @Transactional(propagation = Propagation.NEVER)
