...
class OrderPersistenceEntityAssemblerTest {
    ...
    //8.31. Relacionando entidades de persistência - 6'40"
    @Mock
    ...
    //8.31. Relacionando entidades de persistência - 7'40"
    @BeforeEach
    public void setup() {
    ...
    //8.26. Mesclando dados dos itens de um pedido - 2'
    @Test
    void givenOrderWithNotItems_shouldRemovePersistenceEntityItems() {
        Order order = OrderTestDataBuilder.anOrder().withItems(false).build(); //criando um Order sem itens
        OrderPersistenceEntity orderPersistenceEntity = OrderPersistenceEntityTestDataBuilder.existingOrder().build(); //Criando um OrderPersistenceEntity com itens
    ...
    //8.26. Mesclando dados dos itens de um pedido - 7'30"
    @Test
    ...
    //8.26. Mesclando dados dos itens de um pedido - 15'50"
    @Test
