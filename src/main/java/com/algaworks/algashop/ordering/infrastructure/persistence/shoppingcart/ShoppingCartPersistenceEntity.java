...
public class ShoppingCartPersistenceEntity {
    ...
    @OneToMany(mappedBy = "shoppingCart", cascade = CascadeType.ALL, orphanRemoval = true)//8.37. Desafio: Implemente persistência para Shopping Cart - Trecho mostrado no desafio, mas que não estava no código fonte da aula
