...
public class OrderPersistenceEntityAssembler {
    ...
    private final CustomerPersistenceEntityRepository customerPersistenceEntityRepository; //8.31. Relacionando entidades de persistência - 2'40"
    ...
    public OrderPersistenceEntity merge(OrderPersistenceEntity orderPersistenceEntity, Order order) {
        ...
        //8.31. Relacionando entidades de persistência - 3'
