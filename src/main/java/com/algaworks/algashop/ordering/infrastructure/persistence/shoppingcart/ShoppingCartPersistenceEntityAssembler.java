...
public class ShoppingCartPersistenceEntityAssembler {
    ...
    public ShoppingCartPersistenceEntity merge(ShoppingCartPersistenceEntity persistenceEntity,
        ...
        persistenceEntity.setCustomer(customerPersistenceEntityRepository.getReferenceById(shoppingCart.customerId().value()));//8.31. Relacionando entidades de persistência - 3'
